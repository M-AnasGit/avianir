...
import RenameModal from '@/services/editor/components/rename-modal';
//@SHADCNUI
...
//@TYPES
import { ElementTypes, Preset } from '@/services/editor/types';
//@CUSTOM HOOKS
import { useEditor } from '@/services/editor/provider';
import { useModal } from '@/components/providers/modal-provider';
import { usePublicPresetData } from '@/services/editor/hooks/usePublicPresetData';
                    ...
                    <ContextMenu key={i}>
                        <ContextMenuTrigger>
                            <Tooltip>
                                <TooltipTrigger>
                                    <div
                                        className="mb-2 flex w-[80px] cursor-pointer flex-col items-center gap-2 rounded-md bg-primary/20 py-4 text-primary-foreground transition-all hover:bg-muted hover:text-muted-foreground"
                                        draggable
